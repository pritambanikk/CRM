...
export function WhatsAppFloater() {
  ...
  const whatsappNumber = "917047683995"; // Format: country code + number (no + or spaces)
  const whatsappMessage = encodeURIComponent("Hi, I need your assistance.");
  ...
  const handleWhatsAppClick = () => {
    // WhatsApp link for both mobile and desktop
  ...
  return (
    <div
      className={cn(
        "fixed right-3 sm:right-6 top-1/2 -translate-y-1/2 z-50 transition-all duration-500 ease-out",
        isVisible
    ...
    >
      ...
      >
        ...
        {/* WhatsApp Logo SVG */}
        <svg
          className="w-7 h-7 text-white relative z-10 shrink-0"
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      {/* Notification Badge (Optional - you can enable this for alerts) */}
