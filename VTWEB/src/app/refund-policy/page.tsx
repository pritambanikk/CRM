...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://vakiltech.in/refund-policy",
  },
};
...
const breadcrumbItems = [
    ...
    { label: "Refund Policy", current: true },
  ];
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    Learn about vakiltech's refund and cancellation policy for our legal services.
                  </p>
                </div>
