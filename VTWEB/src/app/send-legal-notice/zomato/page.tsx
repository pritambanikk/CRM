...
export const metadata: Metadata = {
  title: "Send Legal Notice to Zomato | Registered Address + Step-by-Step Guide | vakiltech",
...
const breadcrumbItems = [
  ...
  return (
    ...
    <script
      ...
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Zomato's registered address for sending a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Send your notice to Zomato Limited (CIN: L93030DL2010PLC198141), Ground Floor 12A, 94 Meghdoot, Nehru Place, New Delhi – 110019. Grievance email: grievance.officer@zomato.com."}},{"@type":"Question","name":"My Zomato order amount is small — is it worth sending a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Yes. Consumer courts handle claims of any amount. A legal notice from an advocate often prompts Zomato to settle immediately to avoid legal costs — even for orders of a few hundred rupees."}},{"@type":"Question","name":"Can I complain about food quality through a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Yes. Poor food quality or contaminated food is both a consumer complaint and a food safety violation. Your notice can cite the Consumer Protection Act 2019, and you can simultaneously file an FSSAI complaint at fssai.gov.in."}},{"@type":"Question","name":"Zomato says the restaurant is responsible, not them. Is that correct?","acceptedAnswer":{"@type":"Answer","text":"Partially. While the restaurant prepares the food, Zomato is jointly responsible as the platform under consumer protection law — especially for non-delivery, payment issues, and for listing restaurants that violate food safety standards."}},{"@type":"Question","name":"How long does Zomato have to respond to a legal notice?","acceptedAnswer":{"@type":"Answer","text":"The notice gives Zomato 15 days to respond. If there is no satisfactory response, you can file a consumer complaint in your city's District Consumer Disputes Redressal Commission."}},{"@type":"Question","name":"How much does it cost to send a legal notice to Zomato?","acceptedAnswer":{"@type":"Answer","text":"vakiltech charges ₹1,499 all-inclusive — consultation with a licensed advocate, custom drafting, unlimited revisions, and Speed Post dispatch with Acknowledgment Due."}}]}` }}
    />
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"vakiltech — Send Legal Notice to Zomato","description":"Send a lawyer-drafted legal notice to Zomato Limited's registered address for food delivery disputes, refund issues, and consumer complaints. ₹1,499.","url":"https://vakiltech.in/send-legal-notice/zomato","areaServed":{"@type":"Country","name":"India"},"provider":{"@type":"Organization","name":"vakiltech","url":"https://vakiltech.in"},"offers":{"@type":"Offer","price":"1499","priceCurrency":"INR"}}` }}
    />
...
<div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Legal Team</div><span className="text-primary font-medium hover:underline break-all">legal@zomato.com</span></div>
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Tired of Bot Replies? Here’s When to Take Action.</h2>
          </div>
          <p className="text-slate-600 text-lg mb-6">You can send Zomato a legal notice when their support has repeatedly failed to resolve a legitimate grievance. Stop arguing with automated chatbots. A legal notice immediately escalates your issue. Common situations include:</p>

          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            <div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">resolve your complaint. Common situations include:</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Food ordered but marked delivered without actual delivery</span></div>
...
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Food arrived in dangerously poor condition — spoiled, foreign objects found</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Delivery executive misbehaviour or fraud</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Zomato Pro or Gold membership benefits not honoured</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Platform fee or surge charges added without disclosure</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Cancelled order with no refund to original payment method</span></div>
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Restaurant listed on Zomato that is permanently closed or unlicensed</span></div>
        ...
        <DidYouKnowBlock 
            title="Did you know?"
            text="Even if Zomato claims 'the restaurant is responsible for the food,' Indian Consumer Law holds the delivery platform jointly liable for deficiency in service, including missing items or dangerously poor food quality." 
        />
