...
export const metadata: Metadata = {
  title: "Send Legal Notice to PhonePe | Registered Address + Complete Guide | vakiltech",
  description: "PhonePe not resolving your complaint? Send a lawyer-drafted legal notice to PhonePe Private Limited's registered address. Resolve consumer disputes legally. \u20b91,499. Drafted in 24 hours.",
  keywords: ["send legal notice to phonepe", "phonepe registered address legal notice", "phonepe grievance officer", "PhonePe consumer complaint", "PhonePe legal notice", "how to file complaint against PhonePe"],
  alternates: {
    canonical: "https://vakiltech.in/send-legal-notice/phonepe",
  },
};

export default function PhonepeLegalNoticePage() {
const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Legal Notice", href: "/send-legal-notice" },
    { label: "Send Legal Notice to PhonePe", current: true },
  ];

  const faqs = [
    {
        "question": "What is PhonePe's registered address for a legal notice?",
        "answer": "Send your notice to PhonePe Private Limited at Office-2, Floor 4, 5, 6, 7, Wing A, Block A, Salarpuria Softzone, Service Road, Green Glen Layout, Bellandur, Bengaluru, Karnataka \u2013 560103. Grievance email: grievance.phonepe.com (online portal)."
    },
    {
        "question": "How long does PhonePe have to respond to a legal notice?",
    ...
    {
        "question": "How much does it cost to send a legal notice to PhonePe?",
  ...
  return (
    ...
    <script
      ...
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is PhonePe's registered address for a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Send your notice to PhonePe Private Limited at Office-2, Floor 4, 5, 6, 7, Wing A, Block A, Salarpuria Softzone, Service Road, Green Glen Layout, Bellandur, Bengaluru, Karnataka – 560103. Grievance email: grievance.phonepe.com (online portal)."}},{"@type":"Question","name":"How long does PhonePe have to respond to a legal notice?","acceptedAnswer":{"@type":"Answer","text":"15 to 30 days as specified in the notice. After that you can file a consumer complaint in the District Consumer Disputes Redressal Commission in your city."}},{"@type":"Question","name":"How much does it cost to send a legal notice to PhonePe?","acceptedAnswer":{"@type":"Answer","text":"vakiltech charges ₹1,499 all-inclusive — consultation, custom drafting, unlimited revisions, and Speed Post dispatch with Acknowledgment Due."}}]}` }}
    />
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"vakiltech — Send Legal Notice to PhonePe","description":"Send a lawyer-drafted legal notice to PhonePe Private Limited for consumer disputes. ₹1,499.","url":"https://vakiltech.in/send-legal-notice/phonepe","areaServed":{"@type":"Country","name":"India"},"provider":{"@type":"Organization","name":"vakiltech","url":"https://vakiltech.in"},"offers":{"@type":"Offer","price":"1499","priceCurrency":"INR"}}` }}
    />
            ...
            <div className="md:col-span-8 space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                  Send Legal Notice to PhonePe — Registered Address, Grievance Officer & Complete Guide
                </h1>
                <p className="text-xl text-slate-600 leading-relaxed font-medium max-w-3xl">If PhonePe has refused your refund, ignored your complaints, or failed</p>
<p className="text-lg text-slate-600">to resolve your dispute despite repeated attempts, a formal legal notice</p>
<p className="text-lg text-slate-600">is your most effective next step. This page gives you PhonePe's verified</p>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 space-y-12">
        ...
        <div className="bg-red-50 border-l-4 border-red-500 rounded-r-xl p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-red-900 mb-2">IMPORTANT — PhonePe's Correct Legal Entity for Consumer Notices</h2>
              <p className="text-red-800/80 mb-4 leading-relaxed">The correct legal entity for consumer complaints is PhonePe Private Limited.</p>
<p className="text-red-800/80 mb-4 leading-relaxed">For UPI failures involving other banks, also approach your bank and RBI Ombudsman (14448). PhonePe's Principal Nodal Officer is Mr. Aniket Baheti.</p>
            </div>
          </div>
        </div>
        ...
        <section className="scroll-mt-24" id="address">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">PhonePe Private Limited — Registered Address for Legal Notice</h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="font-bold text-slate-900 text-lg">PhonePe Private Limited</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4 bg-slate-50/50">
                ...
                <div className="font-mono text-slate-700 bg-white border border-slate-200 px-3 py-1 rounded inline-block w-max">U67190KA2012PTC176031</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="text-slate-700 leading-relaxed font-medium">
                  <span dangerouslySetInnerHTML={{__html: `Office-2, Floor 4, 5, 6, 7, Wing A, Block A, Salarpuria Softzone, Service Road, Green Glen Layout, Bellandur, Bengaluru, Karnataka – 560103`}} />
                </div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-6 bg-white">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Grievance Officer</div><span className="text-primary font-medium hover:underline break-all">grievance.phonepe.com (online portal)</span></div>
<div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Legal Team</div><span className="text-primary font-medium hover:underline break-all">corp.sec@phonepe.com</span></div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="font-semibold text-slate-500 flex items-center gap-2">
                  ...
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 h-[calc(100%-2rem)] flex flex-col justify-center">
                    ...
                    <div className="text-slate-900 font-bold text-lg">080-68727374 / 022-68727374</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Failed UPI Transfers or Hidden Charges? When to Take Action.</h2>
          </div>
          <p className="text-slate-600 text-lg mb-6">UPI is designed to be instant. However, when money is deducted from your bank and trapped in digital limbo—or if you face issues with PhonePe insurance or gold purchases—waiting endlessly is unacceptable. A legal notice forces an immediate investigation. Top complaints include:</p>
...
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">UPI payment failed but money debited and not refunded, fraudulent transaction disputed but claim rejected, KYC issues blocking account, wallet balance stuck or inaccessible, merchant payment dispute, account suspended without notice</span></div>
          </div>
        ...
        <DidYouKnowBlock 
            title="Did you know?"
            text="UPI apps like PhonePe are strictly bound by the RBI’s Turn Around Time (TAT) framework. If a failed transaction isn't reversed within T+1 days, they are legally liable to pay you a penalty of ₹100 per day of delay." 
        />
        ...
        <section>
          ...
          <div className="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-10 pb-4">
            <div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 1 — Contact PhonePe Customer Support</h3>
...
<div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 2 — Escalate to PhonePe Grievance Officer</h3>
...
<div className="relative pl-8 md:pl-10">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-3xl p-8 shadow-sm">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-emerald-50"><p className="text-slate-700 text-lg leading-relaxed mb-6 italic hover:not-italic transition-all duration-500">"Suresh Gupta from Ahmedabad made a ₹15,000 UPI transfer that failed but was debited from his account. PhonePe's support said the money was transferred successfully. After 30 days of no refund and no resolution, a legal notice was sent. PhonePe reversed the transaction within 48 hours."</p><div className="text-xs text-slate-400 pt-4 border-t border-slate-100">Note: This is a representative example based on the typical outcome of legal notices in consumer disputes. Individual results may vary.</div></div>
        </section>
