...
export const metadata: Metadata = {
  title: "Send Legal Notice to Ola Electric | Registered Address + Complete Guide | vakiltech",
  description: "Ola Electric not resolving your complaint? Send a lawyer-drafted legal notice to Ola Electric Mobility Limited's registered address. Resolve consumer disputes legally. \u20b91,499. Drafted in 24 hours.",
  keywords: ["send legal notice to ola-electric", "ola-electric registered address legal notice", "ola-electric grievance officer", "Ola Electric consumer complaint", "Ola Electric legal notice", "how to file complaint against Ola Electric"],
  alternates: {
    canonical: "https://vakiltech.in/send-legal-notice/ola-electric",
  },
};

export default function OlaElectricLegalNoticePage() {
const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Legal Notice", href: "/send-legal-notice" },
    { label: "Send Legal Notice to Ola Electric", current: true },
  ];

  const faqs = [
    {
        "question": "What is Ola Electric's registered address for a legal notice?",
        "answer": "Send your notice to Ola Electric Mobility Limited at Wing C, Prestige RMZ Startech, Hosur Road, Municipal Ward No. 67, Municipal No. 140, Industrial Layout, Koramangala, Bengaluru \u2013 560095, Karnataka. Grievance email: support@olaelectric.com."
    },
    {
        "question": "How long does Ola Electric have to respond to a legal notice?",
        "answer": "15 to 30 days as specified in the notice. After that you can file in the District Consumer Disputes Redressal Commission in your city."
    },
    {
        "question": "Can I file a consumer complaint in my city even if Ola Electric is registered elsewhere?",
        "answer": "Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."
    },
    {
        "question": "How much does it cost to send a legal notice to Ola Electric?",
  ...
  return (
    ...
    <script
      ...
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Ola Electric's registered address for a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Send your notice to Ola Electric Mobility Limited at Wing C, Prestige RMZ Startech, Hosur Road, Municipal Ward No. 67, Municipal No. 140, Industrial Layout, Koramangala, Bengaluru – 560095, Karnataka. Grievance email: support@olaelectric.com."}},{"@type":"Question","name":"How long does Ola Electric have to respond to a legal notice?","acceptedAnswer":{"@type":"Answer","text":"15 to 30 days as specified in the notice. After that you can file in the District Consumer Disputes Redressal Commission in your city."}},{"@type":"Question","name":"Can I file a consumer complaint in my city even if Ola Electric is registered elsewhere?","acceptedAnswer":{"@type":"Answer","text":"Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."}},{"@type":"Question","name":"How much does it cost to send a legal notice to Ola Electric?","acceptedAnswer":{"@type":"Answer","text":"vakiltech charges ₹1,499 all-inclusive — consultation, custom drafting, unlimited revisions, and Speed Post dispatch with Acknowledgment Due."}}]}` }}
    />
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"vakiltech — Send Legal Notice to Ola Electric","description":"Send a lawyer-drafted legal notice to Ola Electric Mobility Limited for consumer disputes. ₹1,499.","url":"https://vakiltech.in/send-legal-notice/ola-electric","areaServed":{"@type":"Country","name":"India"},"provider":{"@type":"Organization","name":"vakiltech","url":"https://vakiltech.in"},"offers":{"@type":"Offer","price":"1499","priceCurrency":"INR"}}` }}
    />
            ...
            <div className="md:col-span-8 space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                  Send Legal Notice to Ola Electric — Registered Address, Grievance Officer & Complete Guide
                </h1>
                <p className="text-xl text-slate-600 leading-relaxed font-medium max-w-3xl">If Ola Electric has refused your refund, ignored your complaints, or failed</p>
<p className="text-lg text-slate-600">to resolve your dispute despite repeated attempts, a formal legal notice</p>
<p className="text-lg text-slate-600">is your most effective next step. This page gives you Ola Electric's verified</p>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 space-y-12">
        ...
        <div className="bg-red-50 border-l-4 border-red-500 rounded-r-xl p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-red-900 mb-2">IMPORTANT — Ola Electric's Correct Legal Entity for Consumer Notices</h2>
              <p className="text-red-800/80 mb-4 leading-relaxed">The correct legal entity for consumer complaints is Ola Electric Mobility Limited.</p>
<p className="text-red-800/80 mb-4 leading-relaxed">Ola Electric is one of the most-complained-about EV companies in India. The CCPA (Central Consumer Protection Authority) has issued multiple notices to Ola Electric regarding service deficiencies. This strengthens your consumer complaint significantly.</p>
            </div>
          </div>
        </div>
        ...
        <section className="scroll-mt-24" id="address">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Ola Electric Mobility Limited — Registered Address for Legal Notice</h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="font-bold text-slate-900 text-lg">Ola Electric Mobility Limited</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4 bg-slate-50/50">
                ...
                <div className="font-mono text-slate-700 bg-white border border-slate-200 px-3 py-1 rounded inline-block w-max">L74999KA2017PLC099619</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="text-slate-700 leading-relaxed font-medium">
                  <span dangerouslySetInnerHTML={{__html: `Wing C, Prestige RMZ Startech, Hosur Road, Municipal Ward No. 67, Municipal No. 140, Industrial Layout, Koramangala, Bengaluru – 560095, Karnataka`}} />
                </div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-6 bg-white">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Grievance Officer</div><span className="text-primary font-medium hover:underline break-all">support@olaelectric.com</span></div>
<div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Legal Team</div><span className="text-primary font-medium hover:underline break-all">companysecretary@olaelectric.com</span></div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="font-semibold text-slate-500 flex items-center gap-2">
                  ...
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 h-[calc(100%-2rem)] flex flex-col justify-center">
                    ...
                    <div className="text-slate-900 font-bold text-lg">080-35440050</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Scooter Defects or Endless Repair Waits? When to Take Action.</h2>
          </div>
          <p className="text-slate-600 text-lg mb-6">Buying an EV is a huge investment. When your Ola Electric scooter repeatedly suffers from software glitches, hardware failures, or sits in a service center for months on end while you make EMI payments, it's a massive deficiency of service. Legal action is required when:</p>
...
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Scooter with manufacturing defect not repaired under warranty, service centre refusing warranty claims, software update causing performance degradation, vehicle fire or safety incident, delivery delay beyond committed date, excessive repair charges for warranty issues</span></div>
          </div>
        ...
        <DidYouKnowBlock 
            title="Did you know?"
            text="Selling a vehicle with major unresolvable defects, or a battery range significantly lower than advertised, constitutes an 'Unfair Trade Practice' under the Consumer Protection Act. This legally entitles you to demand a full replacement or refund." 
        />
        ...
        <section>
          ...
          <div className="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-10 pb-4">
            <div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 1 — Contact Ola Electric Customer Support</h3>
              <p className="text-slate-600 leading-relaxed mb-4">Use the official app or website. Note all ticket IDs and screenshot all conversations and chat responses.</p>
            </div>
<div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 2 — Escalate to Ola Electric Grievance Officer</h3>
              <p className="text-slate-600 leading-relaxed mb-4">Email the grievance officer with full complaint details and all previous reference numbers. They must respond within 15 days under IT Act 2000.</p>
            </div>
...
<div className="relative pl-8 md:pl-10">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">Send a formal legal notice through a licensed advocate. This escalates the matter to Ola Electric's legal team directly.</p>
            </div>
<div className="relative pl-8 md:pl-10">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-3xl p-8 shadow-sm">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-emerald-50"><p className="text-slate-700 text-lg leading-relaxed mb-6 italic hover:not-italic transition-all duration-500">"Arjun Mehta from Pune purchased an Ola S1 Pro scooter for ₹1.35 lakhs. The scooter developed a battery issue within 3 months. The service centre kept the scooter for 6 weeks and returned it unrepaired. A legal notice citing Consumer Protection Act and Motor Vehicles Act resulted in Ola Electric replacing the battery module within 10 days."</p><div className="text-xs text-slate-400 pt-4 border-t border-slate-100">Note: This is a representative example based on the typical outcome of legal notices in consumer disputes. Individual results may vary.</div></div>
        </section>
        ...
        <section>
          ...
          <div className="bg-primary/5 border border-primary/20 p-6 rounded-2xl text-slate-800">
            ...
            clear deficiency of service in addition to the principal refund.
          </div>
        </section>
