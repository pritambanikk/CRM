...
export const metadata: Metadata = {
  title: "Send Legal Notice to Rapido | Registered Address + Complete Guide | vakiltech",
  description: "Rapido not resolving your complaint? Send a lawyer-drafted legal notice to Roppen Transportation Services Private Limited (Rapido)'s registered address. Resolve consumer disputes legally. \u20b91,499. Drafted in 24 hours.",
  keywords: ["send legal notice to rapido", "rapido registered address legal notice", "rapido grievance officer", "Rapido consumer complaint", "Rapido legal notice", "how to file complaint against Rapido"],
  alternates: {
    canonical: "https://vakiltech.in/send-legal-notice/rapido",
  },
};

export default function RapidoLegalNoticePage() {
const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Legal Notice", href: "/send-legal-notice" },
    { label: "Send Legal Notice to Rapido", current: true },
  ];

  const faqs = [
    {
        "question": "What is Rapido's registered address for a legal notice?",
        "answer": "Send your notice to Roppen Transportation Services Private Limited (Rapido) at Koramangala, Bengaluru, Karnataka (verify latest address on MCA portal at mcaservices.gov.in). Grievance email: support@rapido.bike."
    },
    {
        "question": "How long does Rapido have to respond to a legal notice?",
    ...
    {
        "question": "Can I file a consumer complaint in my city even if Rapido is registered elsewhere?",
        "answer": "Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."
    },
    {
        "question": "How much does it cost to send a legal notice to Rapido?",
  ...
  return (
    ...
    <script
      ...
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Rapido's registered address for a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Send your notice to Roppen Transportation Services Private Limited (Rapido) at Koramangala, Bengaluru, Karnataka (verify latest address on MCA portal at mcaservices.gov.in). Grievance email: support@rapido.bike."}},{"@type":"Question","name":"How long does Rapido have to respond to a legal notice?","acceptedAnswer":{"@type":"Answer","text":"15 to 30 days as specified in the notice. After that you can file in the District Consumer Disputes Redressal Commission in your city."}},{"@type":"Question","name":"Can I file a consumer complaint in my city even if Rapido is registered elsewhere?","acceptedAnswer":{"@type":"Answer","text":"Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."}},{"@type":"Question","name":"How much does it cost to send a legal notice to Rapido?","acceptedAnswer":{"@type":"Answer","text":"vakiltech charges ₹1,499 all-inclusive — consultation, custom drafting, unlimited revisions, and Speed Post dispatch with Acknowledgment Due."}}]}` }}
    />
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"vakiltech — Send Legal Notice to Rapido","description":"Send a lawyer-drafted legal notice to Roppen Transportation Services Private Limited (Rapido) for consumer disputes. ₹1,499.","url":"https://vakiltech.in/send-legal-notice/rapido","areaServed":{"@type":"Country","name":"India"},"provider":{"@type":"Organization","name":"vakiltech","url":"https://vakiltech.in"},"offers":{"@type":"Offer","price":"1499","priceCurrency":"INR"}}` }}
    />
            ...
            <div className="md:col-span-8 space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                  Send Legal Notice to Rapido — Registered Address, Grievance Officer & Complete Guide
                </h1>
                <p className="text-xl text-slate-600 leading-relaxed font-medium max-w-3xl">If Rapido has refused your refund, ignored your complaints, or failed</p>
<p className="text-lg text-slate-600">to resolve your dispute despite repeated attempts, a formal legal notice</p>
<p className="text-lg text-slate-600">is your most effective next step. This page gives you Rapido's verified</p>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 space-y-12">
        ...
        <div className="bg-red-50 border-l-4 border-red-500 rounded-r-xl p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-red-900 mb-2">IMPORTANT — Rapido's Correct Legal Entity for Consumer Notices</h2>
              <p className="text-red-800/80 mb-4 leading-relaxed">The correct legal entity for consumer complaints is Roppen Transportation Services Private Limited (Rapido).</p>
<p className="text-red-800/80 mb-4 leading-relaxed">Rapido connects users with bike taxi and auto services. It is regulated under Motor Vehicles Act in states where bike taxis are permitted. Note that bike taxis are not yet legal in all states — check local regulations.</p>
            </div>
          </div>
        </div>
        ...
        <section className="scroll-mt-24" id="address">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Roppen Transportation Services Private Limited (Rapido) — Registered Address for Legal Notice</h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="font-bold text-slate-900 text-lg">Roppen Transportation Services Private Limited (Rapido)</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4 bg-slate-50/50">
                ...
                <div className="font-mono text-slate-700 bg-white border border-slate-200 px-3 py-1 rounded inline-block w-max">U60221KA2015PTC081320</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="text-slate-700 leading-relaxed font-medium">
                  <span dangerouslySetInnerHTML={{__html: `Koramangala, Bengaluru, Karnataka (verify latest address on MCA portal at mcaservices.gov.in)`}} />
                </div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-6 bg-white">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Grievance Officer</div><span className="text-primary font-medium hover:underline break-all">support@rapido.bike</span></div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="font-semibold text-slate-500 flex items-center gap-2">
                  ...
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 h-[calc(100%-2rem)] flex flex-col justify-center">
                    ...
                    <div className="text-slate-900 font-bold text-lg">Contact via app</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Reckless Rides or Accidents? When to Take Action.</h2>
          </div>
          <p className="text-slate-600 text-lg mb-6">Rapido provides quick bike commutes, but that comes with steep liability risks. If an unsafe ride resulted in physical injury, harassment, or financial overcharging and their help center gave you the cold shoulder, a legal notice escalates liability directly. We typically see notices for:</p>
...
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Overcharging beyond meter or app estimate, driver cancelled mid-trip with charges applied, safety incident during ride, refund for cancelled or incomplete ride not received, account blocked without reason</span></div>
          </div>
        ...
        <DidYouKnowBlock 
            title="Did you know?"
            text="In the event of an accident caused by reckless driving on a bike taxi platform like Rapido, you are legally entitled to claim medical compensation and damages beyond a simple 'refund of your ride fare.'" 
        />
        ...
        <section>
          ...
          <div className="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-10 pb-4">
            <div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 1 — Contact Rapido Customer Support</h3>
...
<div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 2 — Escalate to Rapido Grievance Officer</h3>
...
<div className="relative pl-8 md:pl-10">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">Send a formal legal notice through a licensed advocate. This escalates the matter to Rapido's legal team directly.</p>
            </div>
<div className="relative pl-8 md:pl-10">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-3xl p-8 shadow-sm">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-emerald-50"><p className="text-slate-700 text-lg leading-relaxed mb-6 italic hover:not-italic transition-all duration-500">"Aditi from Hyderabad was charged ₹450 for a Rapido auto ride that the app estimated at ₹120. The driver took a different route. Rapido support said fares can vary. A legal notice citing unfair trade practice resulted in Rapido refunding the overcharge within 5 days."</p><div className="text-xs text-slate-400 pt-4 border-t border-slate-100">Note: This is a representative example based on the typical outcome of legal notices in consumer disputes. Individual results may vary.</div></div>
        </section>
