...
export const metadata: Metadata = {
  title: "Send Legal Notice to Zepto | Registered Address + Complete Guide | vakiltech",
  description: "Zepto not resolving your complaint? Send a lawyer-drafted legal notice to Kiranakart Technologies Private Limited (Zepto)'s registered address. Resolve consumer disputes legally. \u20b91,499. Drafted in 24 hours.",
  keywords: ["send legal notice to zepto", "zepto registered address legal notice", "zepto grievance officer", "Zepto consumer complaint", "Zepto legal notice", "how to file complaint against Zepto"],
  alternates: {
    canonical: "https://vakiltech.in/send-legal-notice/zepto",
  },
};

export default function ZeptoLegalNoticePage() {
const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Legal Notice", href: "/send-legal-notice" },
    { label: "Send Legal Notice to Zepto", current: true },
  ];

  const faqs = [
    {
        "question": "What is Zepto's registered address for a legal notice?",
        "answer": "Send your notice to Kiranakart Technologies Private Limited (Zepto) at 1st Floor, A Wing, Kanakia Zillion, LBS Marg, BKC Annexe, Kurla West, Mumbai, Maharashtra \u2013 400070. Grievance email: support@zepto.com."
    },
    {
        "question": "How long does Zepto have to respond to a legal notice?",
    ...
    {
        "question": "Can I file a consumer complaint in my city even if Zepto is registered elsewhere?",
        "answer": "Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."
    },
    {
        "question": "How much does it cost to send a legal notice to Zepto?",
  ...
  return (
    ...
    <script
      ...
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Zepto's registered address for a legal notice?","acceptedAnswer":{"@type":"Answer","text":"Send your notice to Kiranakart Technologies Private Limited (Zepto) at 1st Floor, A Wing, Kanakia Zillion, LBS Marg, BKC Annexe, Kurla West, Mumbai, Maharashtra – 400070. Grievance email: support@zepto.com."}},{"@type":"Question","name":"How long does Zepto have to respond to a legal notice?","acceptedAnswer":{"@type":"Answer","text":"15 to 30 days as specified in the notice. After that you can file in the District Consumer Disputes Redressal Commission in your city."}},{"@type":"Question","name":"Can I file a consumer complaint in my city even if Zepto is registered elsewhere?","acceptedAnswer":{"@type":"Answer","text":"Yes. Under the Consumer Protection Act 2019, you can file where you reside or where the transaction took place."}},{"@type":"Question","name":"How much does it cost to send a legal notice to Zepto?","acceptedAnswer":{"@type":"Answer","text":"vakiltech charges ₹1,499 all-inclusive — consultation, custom drafting, unlimited revisions, and Speed Post dispatch with Acknowledgment Due."}}]}` }}
    />
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"vakiltech — Send Legal Notice to Zepto","description":"Send a lawyer-drafted legal notice to Kiranakart Technologies Private Limited (Zepto) for consumer disputes. ₹1,499.","url":"https://vakiltech.in/send-legal-notice/zepto","areaServed":{"@type":"Country","name":"India"},"provider":{"@type":"Organization","name":"vakiltech","url":"https://vakiltech.in"},"offers":{"@type":"Offer","price":"1499","priceCurrency":"INR"}}` }}
    />
            ...
            <div className="md:col-span-8 space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                  Send Legal Notice to Zepto — Registered Address, Grievance Officer & Complete Guide
                </h1>
                <p className="text-xl text-slate-600 leading-relaxed font-medium max-w-3xl">If Zepto has refused your refund, ignored your complaints, or failed</p>
<p className="text-lg text-slate-600">to resolve your dispute despite repeated attempts, a formal legal notice</p>
<p className="text-lg text-slate-600">is your most effective next step. This page gives you Zepto's verified</p>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 space-y-12">
        ...
        <div className="bg-red-50 border-l-4 border-red-500 rounded-r-xl p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-red-900 mb-2">IMPORTANT — Zepto's Correct Legal Entity for Consumer Notices</h2>
              <p className="text-red-800/80 mb-4 leading-relaxed">The correct legal entity for consumer complaints is Kiranakart Technologies Private Limited (Zepto).</p>
<p className="text-red-800/80 mb-4 leading-relaxed">Zepto is a private company focused on 10-minute grocery delivery. Being unlisted, consumer court is an effective avenue alongside legal notices.</p>
            </div>
          </div>
        </div>
        ...
        <section className="scroll-mt-24" id="address">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Kiranakart Technologies Private Limited (Zepto) — Registered Address for Legal Notice</h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="font-bold text-slate-900 text-lg">Kiranakart Technologies Private Limited (Zepto)</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4 bg-slate-50/50">
                ...
                <div className="font-mono text-slate-700 bg-white border border-slate-200 px-3 py-1 rounded inline-block w-max">U52100MH2021PTC367962</div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-[200px_1fr] gap-4">
                ...
                <div className="text-slate-700 leading-relaxed font-medium">
                  <span dangerouslySetInnerHTML={{__html: `1st Floor, A Wing, Kanakia Zillion, LBS Marg, BKC Annexe, Kurla West, Mumbai, Maharashtra – 400070`}} />
                </div>
              </div>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-6 bg-white">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-100"><div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Grievance Officer</div><span className="text-primary font-medium hover:underline break-all">support@zepto.com</span></div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="font-semibold text-slate-500 flex items-center gap-2">
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Missing Groceries or Refused Refunds? When to Take Action.</h2>
          </div>
          <p className="text-slate-600 text-lg mb-6">Zepto promises rapid delivery, but when items are entirely missing from your bag and the automated support refuses to refund your hard-earned money, you shouldn't just let it slide. A legal notice tells them you mean business. Common scenarios include:</p>
...
<div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" /><span className="text-slate-700 font-medium leading-snug">Missing items, wrong product delivered, expired or near-expiry groceries, order not delivered but marked complete, refund not credited, substitution without prior consent</span></div>
          </div>
        ...
        <DidYouKnowBlock 
            title="Did you know?"
            text="'10-minute delivery' is a formal service promise. If you are routinely penalized with cancellation charges or denied refunds for delayed or missing grocery orders, it constitutes an 'unfair trade practice' under Indian law." 
        />
        ...
        <section>
          ...
          <div className="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-10 pb-4">
            <div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 1 — Contact Zepto Customer Support</h3>
...
<div className="relative pl-8 md:pl-10">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Step 2 — Escalate to Zepto Grievance Officer</h3>
...
<div className="relative pl-8 md:pl-10">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">Send a formal legal notice through a licensed advocate. This escalates the matter to Zepto's legal team directly.</p>
            </div>
<div className="relative pl-8 md:pl-10">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-3xl p-8 shadow-sm">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-emerald-50"><p className="text-slate-700 text-lg leading-relaxed mb-6 italic hover:not-italic transition-all duration-500">"Sunita from Mumbai received a milk packet from Zepto that had expired 4 days earlier. Zepto's support said it was a packaging date issue. A legal notice citing the Food Safety and Standards Act and Consumer Protection Act resulted in a refund plus ₹500 goodwill credit within 3 days."</p><div className="text-xs text-slate-400 pt-4 border-t border-slate-100">Note: This is a representative example based on the typical outcome of legal notices in consumer disputes. Individual results may vary.</div></div>
        </section>
