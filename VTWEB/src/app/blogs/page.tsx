...
export const metadata: Metadata = {
  title: "Legal Blog & Insights | vakiltech",
  description: "Explore our latest articles, guides, and legal insights on property law, criminal law, divorce, and more.",
  ...
  alternates: {
    canonical: "https://vakiltech.in/blogs",
  },
};
...
const breadcrumbItems = [
    ...
    { label: "Legal Blog & Insights", current: true },
  ];
...
<h2 className="text-2xl font-bold text-foreground mb-4">Need Legal Help? Get Expert Consultation Today</h2>
<p className="text-muted-foreground mb-4">Connect with experienced advocates who can guide you through any legal matter.</p>
</div>
